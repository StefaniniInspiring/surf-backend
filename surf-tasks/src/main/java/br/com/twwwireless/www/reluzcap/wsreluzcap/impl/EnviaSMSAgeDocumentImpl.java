 ...
 */
public class EnviaSMSAgeDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements br.com.twwwireless.www.reluzcap.wsreluzcap.EnviaSMSAgeDocument
{
    private static final long serialVersionUID = 1L;
    
    public EnviaSMSAgeDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName ENVIASMSAGE$0 = 
        new javax.xml.namespace.QName("https://www.twwwireless.com.br/reluzcap/wsreluzcap", "EnviaSMSAge");
    
    
    /**
     * Gets the "EnviaSMSAge" element
     */
    public br.com.twwwireless.www.reluzcap.wsreluzcap.EnviaSMSAgeDocument.EnviaSMSAge getEnviaSMSAge()
    {
        synchronized (monitor())
        {
            check_orphaned();
            br.com.twwwireless.www.reluzcap.wsreluzcap.EnviaSMSAgeDocument.EnviaSMSAge target = null;
            target = (br.com.twwwireless.www.reluzcap.wsreluzcap.EnviaSMSAgeDocument.EnviaSMSAge)get_store().find_element_user(ENVIASMSAGE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setEnviaSMSAge(br.com.twwwireless.www.reluzcap.wsreluzcap.EnviaSMSAgeDocument.EnviaSMSAge enviaSMSAge)
    {
        generatedSetterHelperImpl(enviaSMSAge, ENVIASMSAGE$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    
    /**
     * Appends and returns a new empty "EnviaSMSAge" element
     */
    public br.com.twwwireless.www.reluzcap.wsreluzcap.EnviaSMSAgeDocument.EnviaSMSAge addNewEnviaSMSAge()
    {
        synchronized (monitor())
        {
            check_orphaned();
            br.com.twwwireless.www.reluzcap.wsreluzcap.EnviaSMSAgeDocument.EnviaSMSAge target = null;
            target = (br.com.twwwireless.www.reluzcap.wsreluzcap.EnviaSMSAgeDocument.EnviaSMSAge)get_store().add_element_user(ENVIASMSAGE$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class EnviaSMSAgeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements br.com.twwwireless.www.reluzcap.wsreluzcap.EnviaSMSAgeDocument.EnviaSMSAge
    {
        private static final long serialVersionUID = 1L;
        
        public EnviaSMSAgeImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
