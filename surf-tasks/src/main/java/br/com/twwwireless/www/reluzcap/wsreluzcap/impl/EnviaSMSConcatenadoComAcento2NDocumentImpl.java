 ...
 */
public class EnviaSMSConcatenadoComAcento2NDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements br.com.twwwireless.www.reluzcap.wsreluzcap.EnviaSMSConcatenadoComAcento2NDocument
{
    private static final long serialVersionUID = 1L;
    
    public EnviaSMSConcatenadoComAcento2NDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName ENVIASMSCONCATENADOCOMACENTO2N$0 = 
        new javax.xml.namespace.QName("https://www.twwwireless.com.br/reluzcap/wsreluzcap", "EnviaSMSConcatenadoComAcento2N");
    
    
    /**
     * Gets the "EnviaSMSConcatenadoComAcento2N" element
     */
    public br.com.twwwireless.www.reluzcap.wsreluzcap.EnviaSMSConcatenadoComAcento2NDocument.EnviaSMSConcatenadoComAcento2N getEnviaSMSConcatenadoComAcento2N()
    {
        synchronized (monitor())
        {
            check_orphaned();
            br.com.twwwireless.www.reluzcap.wsreluzcap.EnviaSMSConcatenadoComAcento2NDocument.EnviaSMSConcatenadoComAcento2N target = null;
            target = (br.com.twwwireless.www.reluzcap.wsreluzcap.EnviaSMSConcatenadoComAcento2NDocument.EnviaSMSConcatenadoComAcento2N)get_store().find_element_user(ENVIASMSCONCATENADOCOMACENTO2N$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setEnviaSMSConcatenadoComAcento2N(br.com.twwwireless.www.reluzcap.wsreluzcap.EnviaSMSConcatenadoComAcento2NDocument.EnviaSMSConcatenadoComAcento2N enviaSMSConcatenadoComAcento2N)
    {
        generatedSetterHelperImpl(enviaSMSConcatenadoComAcento2N, ENVIASMSCONCATENADOCOMACENTO2N$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    
    /**
     * Appends and returns a new empty "EnviaSMSConcatenadoComAcento2N" element
     */
    public br.com.twwwireless.www.reluzcap.wsreluzcap.EnviaSMSConcatenadoComAcento2NDocument.EnviaSMSConcatenadoComAcento2N addNewEnviaSMSConcatenadoComAcento2N()
    {
        synchronized (monitor())
        {
            check_orphaned();
            br.com.twwwireless.www.reluzcap.wsreluzcap.EnviaSMSConcatenadoComAcento2NDocument.EnviaSMSConcatenadoComAcento2N target = null;
            target = (br.com.twwwireless.www.reluzcap.wsreluzcap.EnviaSMSConcatenadoComAcento2NDocument.EnviaSMSConcatenadoComAcento2N)get_store().add_element_user(ENVIASMSCONCATENADOCOMACENTO2N$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class EnviaSMSConcatenadoComAcento2NImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements br.com.twwwireless.www.reluzcap.wsreluzcap.EnviaSMSConcatenadoComAcento2NDocument.EnviaSMSConcatenadoComAcento2N
    {
        private static final long serialVersionUID = 1L;
        
        public EnviaSMSConcatenadoComAcento2NImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
