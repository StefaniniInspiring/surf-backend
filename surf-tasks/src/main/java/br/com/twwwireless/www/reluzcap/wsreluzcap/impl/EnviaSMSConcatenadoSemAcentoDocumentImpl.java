 ...
 */
public class EnviaSMSConcatenadoSemAcentoDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements br.com.twwwireless.www.reluzcap.wsreluzcap.EnviaSMSConcatenadoSemAcentoDocument
{
    private static final long serialVersionUID = 1L;
    
    public EnviaSMSConcatenadoSemAcentoDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName ENVIASMSCONCATENADOSEMACENTO$0 = 
        new javax.xml.namespace.QName("https://www.twwwireless.com.br/reluzcap/wsreluzcap", "EnviaSMSConcatenadoSemAcento");
    
    
    /**
     * Gets the "EnviaSMSConcatenadoSemAcento" element
     */
    public br.com.twwwireless.www.reluzcap.wsreluzcap.EnviaSMSConcatenadoSemAcentoDocument.EnviaSMSConcatenadoSemAcento getEnviaSMSConcatenadoSemAcento()
    {
        synchronized (monitor())
        {
            check_orphaned();
            br.com.twwwireless.www.reluzcap.wsreluzcap.EnviaSMSConcatenadoSemAcentoDocument.EnviaSMSConcatenadoSemAcento target = null;
            target = (br.com.twwwireless.www.reluzcap.wsreluzcap.EnviaSMSConcatenadoSemAcentoDocument.EnviaSMSConcatenadoSemAcento)get_store().find_element_user(ENVIASMSCONCATENADOSEMACENTO$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setEnviaSMSConcatenadoSemAcento(br.com.twwwireless.www.reluzcap.wsreluzcap.EnviaSMSConcatenadoSemAcentoDocument.EnviaSMSConcatenadoSemAcento enviaSMSConcatenadoSemAcento)
    {
        generatedSetterHelperImpl(enviaSMSConcatenadoSemAcento, ENVIASMSCONCATENADOSEMACENTO$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    
    /**
     * Appends and returns a new empty "EnviaSMSConcatenadoSemAcento" element
     */
    public br.com.twwwireless.www.reluzcap.wsreluzcap.EnviaSMSConcatenadoSemAcentoDocument.EnviaSMSConcatenadoSemAcento addNewEnviaSMSConcatenadoSemAcento()
    {
        synchronized (monitor())
        {
            check_orphaned();
            br.com.twwwireless.www.reluzcap.wsreluzcap.EnviaSMSConcatenadoSemAcentoDocument.EnviaSMSConcatenadoSemAcento target = null;
            target = (br.com.twwwireless.www.reluzcap.wsreluzcap.EnviaSMSConcatenadoSemAcentoDocument.EnviaSMSConcatenadoSemAcento)get_store().add_element_user(ENVIASMSCONCATENADOSEMACENTO$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class EnviaSMSConcatenadoSemAcentoImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements br.com.twwwireless.www.reluzcap.wsreluzcap.EnviaSMSConcatenadoSemAcentoDocument.EnviaSMSConcatenadoSemAcento
    {
        private static final long serialVersionUID = 1L;
        
        public EnviaSMSConcatenadoSemAcentoImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
