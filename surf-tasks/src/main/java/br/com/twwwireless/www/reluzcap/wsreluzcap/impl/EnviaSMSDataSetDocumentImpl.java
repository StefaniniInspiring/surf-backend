 ...
 */
public class EnviaSMSDataSetDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements br.com.twwwireless.www.reluzcap.wsreluzcap.EnviaSMSDataSetDocument
{
    private static final long serialVersionUID = 1L;
    
    public EnviaSMSDataSetDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName ENVIASMSDATASET$0 = 
        new javax.xml.namespace.QName("https://www.twwwireless.com.br/reluzcap/wsreluzcap", "EnviaSMSDataSet");
    
    
    /**
     * Gets the "EnviaSMSDataSet" element
     */
    public br.com.twwwireless.www.reluzcap.wsreluzcap.EnviaSMSDataSetDocument.EnviaSMSDataSet getEnviaSMSDataSet()
    {
        synchronized (monitor())
        {
            check_orphaned();
            br.com.twwwireless.www.reluzcap.wsreluzcap.EnviaSMSDataSetDocument.EnviaSMSDataSet target = null;
            target = (br.com.twwwireless.www.reluzcap.wsreluzcap.EnviaSMSDataSetDocument.EnviaSMSDataSet)get_store().find_element_user(ENVIASMSDATASET$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setEnviaSMSDataSet(br.com.twwwireless.www.reluzcap.wsreluzcap.EnviaSMSDataSetDocument.EnviaSMSDataSet enviaSMSDataSet)
    {
        generatedSetterHelperImpl(enviaSMSDataSet, ENVIASMSDATASET$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    
    /**
     * Appends and returns a new empty "EnviaSMSDataSet" element
     */
    public br.com.twwwireless.www.reluzcap.wsreluzcap.EnviaSMSDataSetDocument.EnviaSMSDataSet addNewEnviaSMSDataSet()
    {
        synchronized (monitor())
        {
            check_orphaned();
            br.com.twwwireless.www.reluzcap.wsreluzcap.EnviaSMSDataSetDocument.EnviaSMSDataSet target = null;
            target = (br.com.twwwireless.www.reluzcap.wsreluzcap.EnviaSMSDataSetDocument.EnviaSMSDataSet)get_store().add_element_user(ENVIASMSDATASET$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class EnviaSMSDataSetImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements br.com.twwwireless.www.reluzcap.wsreluzcap.EnviaSMSDataSetDocument.EnviaSMSDataSet
    {
        private static final long serialVersionUID = 1L;
        
        public EnviaSMSDataSetImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
         ...
         * Gets the "DS" element
         */
        public br.com.twwwireless.www.reluzcap.wsreluzcap.EnviaSMSDataSetDocument.EnviaSMSDataSet.DS getDS()
        {
            synchronized (monitor())
            {
                check_orphaned();
                br.com.twwwireless.www.reluzcap.wsreluzcap.EnviaSMSDataSetDocument.EnviaSMSDataSet.DS target = null;
                target = (br.com.twwwireless.www.reluzcap.wsreluzcap.EnviaSMSDataSetDocument.EnviaSMSDataSet.DS)get_store().find_element_user(DS$4, 0);
                if (target == null)
                {
                    return null;
                }
         ...
         * Sets the "DS" element
         */
        public void setDS(br.com.twwwireless.www.reluzcap.wsreluzcap.EnviaSMSDataSetDocument.EnviaSMSDataSet.DS ds)
        {
         ...
         */
        public br.com.twwwireless.www.reluzcap.wsreluzcap.EnviaSMSDataSetDocument.EnviaSMSDataSet.DS addNewDS()
        {
            synchronized (monitor())
            {
                check_orphaned();
                br.com.twwwireless.www.reluzcap.wsreluzcap.EnviaSMSDataSetDocument.EnviaSMSDataSet.DS target = null;
                target = (br.com.twwwireless.www.reluzcap.wsreluzcap.EnviaSMSDataSetDocument.EnviaSMSDataSet.DS)get_store().add_element_user(DS$4);
                return target;
            }
        }
         ...
         * This is a complex type.
         */
        public static class DSImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements br.com.twwwireless.www.reluzcap.wsreluzcap.EnviaSMSDataSetDocument.EnviaSMSDataSet.DS
        {
            private static final long serialVersionUID = 1L;
