 ...
 */
public class StatusSMSDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements br.com.twwwireless.www.reluzcap.wsreluzcap.StatusSMSDocument
{
    private static final long serialVersionUID = 1L;
    
    public StatusSMSDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName STATUSSMS$0 = 
        new javax.xml.namespace.QName("https://www.twwwireless.com.br/reluzcap/wsreluzcap", "StatusSMS");
    
    
    /**
     * Gets the "StatusSMS" element
     */
    public br.com.twwwireless.www.reluzcap.wsreluzcap.StatusSMSDocument.StatusSMS getStatusSMS()
    {
        synchronized (monitor())
        {
            check_orphaned();
            br.com.twwwireless.www.reluzcap.wsreluzcap.StatusSMSDocument.StatusSMS target = null;
            target = (br.com.twwwireless.www.reluzcap.wsreluzcap.StatusSMSDocument.StatusSMS)get_store().find_element_user(STATUSSMS$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setStatusSMS(br.com.twwwireless.www.reluzcap.wsreluzcap.StatusSMSDocument.StatusSMS statusSMS)
    {
        generatedSetterHelperImpl(statusSMS, STATUSSMS$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    
    /**
     * Appends and returns a new empty "StatusSMS" element
     */
    public br.com.twwwireless.www.reluzcap.wsreluzcap.StatusSMSDocument.StatusSMS addNewStatusSMS()
    {
        synchronized (monitor())
        {
            check_orphaned();
            br.com.twwwireless.www.reluzcap.wsreluzcap.StatusSMSDocument.StatusSMS target = null;
            target = (br.com.twwwireless.www.reluzcap.wsreluzcap.StatusSMSDocument.StatusSMS)get_store().add_element_user(STATUSSMS$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class StatusSMSImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements br.com.twwwireless.www.reluzcap.wsreluzcap.StatusSMSDocument.StatusSMS
    {
        private static final long serialVersionUID = 1L;
        
        public StatusSMSImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
