...
<wsdl:definitions xmlns:s="http://www.w3.org/2001/XMLSchema" xmlns:soap12="http://schemas.xmlsoap.org/wsdl/soap12/" xmlns:http="http://schemas.xmlsoap.org/wsdl/http/" xmlns:mime="http://schemas.xmlsoap.org/wsdl/mime/" xmlns:tns="https://www.twwwireless.com.br/reluzcap/wsreluzcap" xmlns:soap="http://schemas.xmlsoap.org/wsdl/soap/" xmlns:tm="http://microsoft.com/wsdl/mime/textMatching/" xmlns:soapenc="http://schemas.xmlsoap.org/soap/encoding/" targetNamespace="https://www.twwwireless.com.br/reluzcap/wsreluzcap" xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">
  ...
  <wsdl:message name="AlteraSenhaHttpGetIn">
    <wsdl:part name="NumUsu" type="s:string" />
    <wsdl:part name="SenhaAntiga" type="s:string" />
    <wsdl:part name="SenhaNova" type="s:string" />
  </wsdl:message>
  <wsdl:message name="AlteraSenhaHttpGetOut">
  ...
  <wsdl:message name="AlteraSenhaHttpPostIn">
    <wsdl:part name="NumUsu" type="s:string" />
    <wsdl:part name="SenhaAntiga" type="s:string" />
    <wsdl:part name="SenhaNova" type="s:string" />
  </wsdl:message>
  <wsdl:message name="AlteraSenhaHttpPostOut">
    <wsdl:part name="Body" element="tns:boolean" />
  </wsdl:message>
  ...
  <wsdl:portType name="ReluzCap_x0020_Web_x0020_ServiceSoap">
    ...
    <wsdl:operation name="AlteraSenha">
      <wsdl:documentation xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">Essa função foi desativada em 14 de março de 2018. Para mais informações contacte a TWW.</wsdl:documentation>
      <wsdl:input message="tns:AlteraSenhaSoapIn" />
      <wsdl:output message="tns:AlteraSenhaSoapOut" />
    </wsdl:operation>
    <wsdl:operation name="VerBL">
      <wsdl:documentation xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">Retorna um DataSet com os celulares incluidos na black list. Retorna Nothing em caso de erro.</wsdl:documentation>
      <wsdl:input message="tns:VerBLSoapIn" />
      <wsdl:output message="tns:VerBLSoapOut" />
    </wsdl:operation>
    <wsdl:operation name="InsBL">
      <wsdl:documentation xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">Insere um número de celular na black list. Retorna 1 em caso de sucesso, 0 caso o celular já esteja na black list, -1 em caso de erro.</wsdl:documentation>
  ...
  <wsdl:portType name="ReluzCap_x0020_Web_x0020_ServiceHttpGet">
    ...
    <wsdl:operation name="AlteraSenha">
      <wsdl:documentation xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">Essa função foi desativada em 14 de março de 2018. Para mais informações contacte a TWW.</wsdl:documentation>
      <wsdl:input message="tns:AlteraSenhaHttpGetIn" />
      <wsdl:output message="tns:AlteraSenhaHttpGetOut" />
    </wsdl:operation>
    <wsdl:operation name="VerBL">
      <wsdl:documentation xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">Retorna um DataSet com os celulares incluidos na black list. Retorna Nothing em caso de erro.</wsdl:documentation>
  ...
  <wsdl:portType name="ReluzCap_x0020_Web_x0020_ServiceHttpPost">
    ...
    <wsdl:operation name="AlteraSenha">
      <wsdl:documentation xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">Essa função foi desativada em 14 de março de 2018. Para mais informações contacte a TWW.</wsdl:documentation>
      <wsdl:input message="tns:AlteraSenhaHttpPostIn" />
      <wsdl:output message="tns:AlteraSenhaHttpPostOut" />
    </wsdl:operation>
    <wsdl:operation name="VerBL">
      <wsdl:documentation xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">Retorna um DataSet com os celulares incluidos na black list. Retorna Nothing em caso de erro.</wsdl:documentation>
  ...
  <wsdl:binding name="ReluzCap_x0020_Web_x0020_ServiceSoap" type="tns:ReluzCap_x0020_Web_x0020_ServiceSoap">
    ...
    <wsdl:operation name="AlteraSenha">
      <soap:operation soapAction="https://www.twwwireless.com.br/reluzcap/wsreluzcap/AlteraSenha" style="document" />
      <wsdl:input>
        <soap:body use="literal" />
      </wsdl:input>
      <wsdl:output>
  ...
  <wsdl:binding name="ReluzCap_x0020_Web_x0020_ServiceSoap12" type="tns:ReluzCap_x0020_Web_x0020_ServiceSoap">
    ...
    <wsdl:operation name="AlteraSenha">
      <soap12:operation soapAction="https://www.twwwireless.com.br/reluzcap/wsreluzcap/AlteraSenha" style="document" />
      <wsdl:input>
        <soap12:body use="literal" />
      </wsdl:input>
      <wsdl:output>
  ...
  <wsdl:binding name="ReluzCap_x0020_Web_x0020_ServiceHttpGet" type="tns:ReluzCap_x0020_Web_x0020_ServiceHttpGet">
    ...
    <wsdl:operation name="AlteraSenha">
      <http:operation location="/AlteraSenha" />
      <wsdl:input>
        <http:urlEncoded />
      </wsdl:input>
      <wsdl:output>
  ...
  <wsdl:service name="ReluzCap_x0020_Web_x0020_Service">
    ...
    <wsdl:port name="ReluzCap_x0020_Web_x0020_ServiceSoap" binding="tns:ReluzCap_x0020_Web_x0020_ServiceSoap">
      <soap:address location="https://webservices2.twwwireless.com.br/reluzcap/wsreluzcap.asmx" />
    </wsdl:port>
    <wsdl:port name="ReluzCap_x0020_Web_x0020_ServiceSoap12" binding="tns:ReluzCap_x0020_Web_x0020_ServiceSoap12">
      <soap12:address location="https://webservices2.twwwireless.com.br/reluzcap/wsreluzcap.asmx" />
    </wsdl:port>
    <wsdl:port name="ReluzCap_x0020_Web_x0020_ServiceHttpGet" binding="tns:ReluzCap_x0020_Web_x0020_ServiceHttpGet">
      <http:address location="https://webservices2.twwwireless.com.br/reluzcap/wsreluzcap.asmx" />
    </wsdl:port>
